      ...
      <div className="wealth-container py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#products" className="text-wealth-gray hover:text-wealth-navy transition-colors">Products</a>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 animate-fade-in">
            <div className="flex flex-col space-y-4">
              ...
              <a href="#products" className="text-wealth-gray hover:text-wealth-navy transition-colors py-2">Products</a>
